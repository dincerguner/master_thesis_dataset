...
SET LOCALCLASSPATH=build\lib\test\junit-3.8.1.jar;build\lib\test\hsqldb-1.7.1.jar;build\lib\log4j-1.2.12.jar;build\lib\commons-collections-3.1.jar;build\lib\oro-2.0.8.jar;build\lib\werken-xpath-0.9.4.jar;build\lib\servletapi-2.3.jar;build\lib\avalon-logkit-2.1.jar;build\lib\jdom-1.0.jar;build\lib\commons-lang-2.1.jar;build\lib\antlr-2.7.5.jar;build\lib\test\junit-3.8.1.jar;build\lib\test\hsqldb-1.7.1.jar;
