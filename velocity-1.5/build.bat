...
SET LOCALCLASSPATH=lib\log4j-1.2.12.jar;lib\commons-collections-3.1.jar;lib\oro-2.0.8.jar;lib\werken-xpath-0.9.4.jar;lib\servletapi-2.3.jar;lib\avalon-logkit-2.1.jar;lib\jdom-1.0.jar;lib\commons-lang-2.1.jar;lib\antlr-2.7.5.jar;lib\test\junit-3.8.1.jar;lib\test\hsqldb-1.7.1.jar;lib\test\junit-3.8.1.jar;lib\test\hsqldb-1.7.1.jar;
