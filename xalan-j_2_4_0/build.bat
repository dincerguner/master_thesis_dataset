...
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% compat_src\org\apache\xalan\xpath\*.java compat_src\org\apache\xalan\xpath\xml\*.java compat_src\org\apache\xalan\xpath\xdom\*.java compat_src\org\apache\xalan\xslt\*.java