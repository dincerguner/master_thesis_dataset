...
SET LOCALCLASSPATH=bin\regexp.jar;bin\ant.jar;bin\java_cup.jar;bin\xml-apis.jar;bin\xalan2jtaglet.jar;bin\BCEL.jar;bin\xercesImpl.jar;bin\xalan2jdoc.jar;bin\bsf.jar;bin\stylebook-1.0-b3_xalan-2.jar;bin\JLex.jar;bin\runtime.jar;
