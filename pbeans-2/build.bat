...
SET LOCALCLASSPATH=ext\jtds-0.7.1.jar;ext\;ext\mysql-connector-java-5.0.5-bin.jar;ext\pg74jdbc3.jar;ext\servlet.jar;
...
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% src\net\sourceforge\pbeans\*.java src\net\sourceforge\pbeans\annotations\*.java src\net\sourceforge\pbeans\data\*.java src\net\sourceforge\pbeans\data\mysql\*.java src\net\sourceforge\pbeans\data\sqlserver\*.java src\net\sourceforge\pbeans\data\postgresql\*.java src\net\sourceforge\pbeans\data\hsqldb\*.java src\net\sourceforge\pbeans\servlet\*.java src\net\sourceforge\pbeans\util\*.java