...
set SRC=src\java\org\apache\lucene
...
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% %SRC%\*.java %SRC%\analysis\*.java %SRC%\analysis\standard\*.java %SRC%\document\*.java %SRC%\index\*.java %SRC%\queryParser\*.java %SRC%\search\*.java %SRC%\search\function\*.java %SRC%\search\payloads\*.java %SRC%\search\spans\*.java %SRC%\store\*.java %SRC%\util\*.java %SRC%\util\cache\*.java
