...
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% bsh\*.java bsh\commands\*.java bsh\reflect\*.java bsh\collection\*.java
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% com\microstar\xml\*.java
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% gnu\regexp\*.java
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% installer\*.java
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% org\gjt\sp\util\*.java org\gjt\sp\jedit\*.java org\gjt\sp\jedit\io\*.java org\gjt\sp\jedit\print\*.java org\gjt\sp\jedit\gui\*.java org\gjt\sp\jedit\options\*.java org\gjt\sp\jedit\proto\jeditresource\*.java org\gjt\sp\jedit\msg\*.java org\gjt\sp\jedit\search\*.java org\gjt\sp\jedit\browser\*.java org\gjt\sp\jedit\textarea\*.java org\gjt\sp\jedit\help\*.java org\gjt\sp\jedit\menu\*.java org\gjt\sp\jedit\pluginmgr\*.java org\gjt\sp\jedit\syntax\*.java org\gjt\sp\jedit\buffer\*.java org\objectweb\asm\*.java