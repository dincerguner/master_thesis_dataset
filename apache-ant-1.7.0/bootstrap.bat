...
"%JAVAC%" %BOOTJAVAC_OPTS% -d %CLASSDIR% %TOOLS%\tar\*.java %TOOLS%\mail\*.java %TOOLS%\bzip2\*.java %TOOLS%\zip\*.java %TOOLS%\ant\*.java %TOOLS%\ant\helper\*.java %TOOLS%\ant\taskdefs\*.java %TOOLS%\ant\taskdefs\optional\extension\*.java %TOOLS%\ant\taskdefs\optional\extension\resolvers\*.java %TOOLS%\ant\taskdefs\optional\javacc\*.java %TOOLS%\ant\taskdefs\optional\*.java %TOOLS%\ant\taskdefs\optional\splash\*.java %TOOLS%\ant\taskdefs\optional\clearcase\*.java %TOOLS%\ant\taskdefs\optional\jdepend\*.java %TOOLS%\ant\taskdefs\optional\sos\*.java %TOOLS%\ant\taskdefs\optional\junit\*.java %TOOLS%\ant\taskdefs\optional\jlink\*.java %TOOLS%\ant\taskdefs\optional\script\*.java %TOOLS%\ant\taskdefs\optional\perforce\*.java %TOOLS%\ant\taskdefs\optional\j2ee\*.java %TOOLS%\ant\taskdefs\optional\ejb\*.java %TOOLS%\ant\taskdefs\optional\starteam\*.java %TOOLS%\ant\taskdefs\optional\dotnet\*.java %TOOLS%\ant\taskdefs\optional\net\*.java %TOOLS%\ant\taskdefs\optional\i18n\*.java %TOOLS%\ant\taskdefs\optional\javah\*.java %TOOLS%\ant\taskdefs\optional\depend\*.java %TOOLS%\ant\taskdefs\optional\depend\constantpool\*.java %TOOLS%\ant\taskdefs\optional\image\*.java %TOOLS%\ant\taskdefs\optional\windows\*.java %TOOLS%\ant\taskdefs\optional\sound\*.java %TOOLS%\ant\taskdefs\optional\vss\*.java %TOOLS%\ant\taskdefs\optional\pvcs\*.java %TOOLS%\ant\taskdefs\optional\ssh\*.java %TOOLS%\ant\taskdefs\optional\native2ascii\*.java %TOOLS%\ant\taskdefs\optional\unix\*.java %TOOLS%\ant\taskdefs\optional\jsp\*.java %TOOLS%\ant\taskdefs\optional\jsp\compilers\*.java %TOOLS%\ant\taskdefs\optional\scm\*.java %TOOLS%\ant\taskdefs\optional\ccm\*.java %TOOLS%\ant\taskdefs\cvslib\*.java %TOOLS%\ant\taskdefs\rmic\*.java %TOOLS%\ant\taskdefs\email\*.java %TOOLS%\ant\taskdefs\compilers\*.java %TOOLS%\ant\taskdefs\condition\*.java %TOOLS%\ant\input\*.java %TOOLS%\ant\types\*.java %TOOLS%\ant\types\optional\*.java %TOOLS%\ant\types\optional\depend\*.java %TOOLS%\ant\types\optional\image\*.java %TOOLS%\ant\types\resources\*.java %TOOLS%\ant\types\resources\selectors\*.java %TOOLS%\ant\types\resources\comparators\*.java %TOOLS%\ant\types\mappers\*.java %TOOLS%\ant\types\selectors\*.java %TOOLS%\ant\types\selectors\modifiedselector\*.java %TOOLS%\ant\types\spi\*.java %TOOLS%\ant\types\resolver\*.java %TOOLS%\ant\dispatch\*.java %TOOLS%\ant\filters\*.java %TOOLS%\ant\filters\util\*.java %TOOLS%\ant\listener\*.java %TOOLS%\ant\launch\*.java %TOOLS%\ant\util\*.java %TOOLS%\ant\util\optional\*.java %TOOLS%\ant\util\java15\*.java %TOOLS%\ant\util\facade\*.java %TOOLS%\ant\util\depend\bcel\*.java %TOOLS%\ant\util\depend\*.java %TOOLS%\ant\util\regexp\*.java %TOOLS%\ant\loader\*.java