...
<body>
			...
			<div id="header"><table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
									<td id="jakartaLogoTD" valign="middle" align="left"><a href="http://jakarta.apache.org"><img id="jakartaLogo" src="images/group-logo.gif" border="0" alt="Jakarta (go to Jakarta Main)" /></a></td>
									<td id="projectLogoTD" valign="middle" align="right"><a href="http://jakarta.apache.org/poi/"><img id="projectLogo" src="images/project-logo.gif" border="0" alt="Avalon (go to Avalon Main)" /></a></td>
						</tr>
			</table></div>
			<!-- end header -->
			<!-- breadcrumb trail (javascript-generated) -->
			<div id="breadcrumbs">
              <a href="http://www.apache.org/" class="menu">apache &gt;</a>
              <a href="http://jakarta.apache.org/" class="menu">jakarta &gt;</a>
              <a href="http://jakarta.apache.org/poi/" class="menu">POI</a>    			
