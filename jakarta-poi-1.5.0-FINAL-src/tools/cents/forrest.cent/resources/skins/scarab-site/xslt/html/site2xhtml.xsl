 ...
 <head>
  ...
  <div id="banner">
    <table border="0" cellspacing="0" cellpadding="8" width="100%">
      <tr>
       <td>
         <a href="@group-logo.href@"><img src="@group-logo.src@" border="0" vspace="0" hspace="0"/></a>
       </td>
  
       <td>
         <div align="right"><a href="@project-logo.href@"><img src="@project-logo.src@" border="0" vspace="0" hspace="0"/></a></div>
...
<div id="footer">
  <table border="0" cellspacing="0" cellpadding="4">
   <tr><td>
     <a href="http://www.apache.org/">Copyright &#x00A9; @year@ @vendor@. All Rights Reserved.</a>
   </td></tr>
        <tr>
