...
<body>
			...
			<div id="header"><table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
									<td id="jakartaLogoTD" valign="middle" align="left"><a href="@group-logo.href@"><img id="jakartaLogo" src="@group-logo.src@" border="0" alt="Jakarta (go to Jakarta Main)" /></a></td>
									<td id="projectLogoTD" valign="middle" align="right"><a href="@project-logo.href@"><img id="projectLogo" src="@project-logo.src@" border="0" alt="Avalon (go to Avalon Main)" /></a></td>
						</tr>
			</table></div>
			<!-- end header -->
